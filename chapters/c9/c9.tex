...
\par The result is shown in the Fig~\ref{fig:zprime-2hdm-limit}. 
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=12cm, height=9cm, trim={6cm 17cm 5.8cm 4.5cm}, clip]{chapters/c9/figures/ZPrime2HDMLimit.pdf}
