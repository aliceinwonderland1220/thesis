...
\par FR track jets are then built by applying the anti-$k_T$ algorithm with R = {0.4, 0.3, 0.2} on selected tracks. Track jets in the fiducial region with \pt $>$ 7~\GeV~and $|\eta| < 2.5$ are accepted as track jets with \pt~$<$ 7~\GeV~are dominated by light jets~\cite{ATL-PHYS-PUB-2014-013}. 				
